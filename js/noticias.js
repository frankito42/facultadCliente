...
async function listarPublicacion() {
    ...
    let response = await fetch('php/listarPublicacion.php?id='+obtenerIdDesdeUrl());
...
function obtenerIdDesdeUrl() {
  ...
  function dibujarPublicacion(publicaciones) {
    ...
    if(publicaciones.direccion_archivo){
        descarga=`  <div onclick="descargar('admin/php/${publicaciones.direccion_archivo}')" style="user-select: none;background: rgb(245 245 245);cursor: pointer;border-radius: 5px;">
                        <div style="padding: 1%;" class="row">
                            <div class="col-md-12">
                                <img style="width: 10%;" src="admin/circulo.png">
